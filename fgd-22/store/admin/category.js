...
export const actions = {
    ...
    storeCategory({ dispatch, commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            //store to Rest API "/categories" with method "POST"
    ...
    getDetailCategory({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            //get to Rest API "/categories/" with method "GET"
    ...
    updateCategory({ dispatch, commit }, { categoryId, payload }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            //store to Rest API "/categories/" with method "POST"
            this.$axios.post(`/categories/${categoryId}`, payload)
    ...
    destroyCategory({ dispatch, commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            //delete to Rest API "/categories/" with method "DELETE"
